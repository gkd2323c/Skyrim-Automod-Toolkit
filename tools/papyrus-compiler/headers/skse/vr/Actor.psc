...
; Bethesda additions in 1.5.3 (to be removed when official scripts are updated)
float Function GetActorValueMax(string value) native
float Function GetWarmthRating() native
bool Function IsOverEncumbered() native
Function SendLycanthropyStateChanged(bool arg) native
Function SendVampirismStateChanged(bool arg) native

; Bethesda additions in 1.5.39 (to be removed when official scripts are updated)
