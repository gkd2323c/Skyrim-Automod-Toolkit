...
; added in VR 1.3.59
Function FadeOutGameRemain(bool abFadingOut, bool abBlackFade, float afSecsBeforeFade, float afFadeDuration) global native
Function PlayerAllowUpdateHmd(bool abValue) global native
...
Function PlayerDelayedMoveTo(ObjectReference akDestination, float afDelay, bool abSetOffsetOnly, bool abAllowUpdateHmd) global native
Function PlayerFollowActor(ObjectReference akTarget) global native
Function PlayerMoveToFacing(ObjectReference akTarget, float afDistance) global native
Function PlayerQuickExitCart() global native
Function VRFadeOutGame(float afFadeDuration, float afSecsBeforeFade) global native
