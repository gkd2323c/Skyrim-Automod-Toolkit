...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Basic Book5.png) Book Information <br> *A Dance in Fire, v4* | | | |
| --- | --- | --- | --- |
| [ID](Skyrim_Form_ID.md) | 00 01AFC1 | | |
| See Also | [Lore version](Lore_A_Dance_in_Fire,_Chapter_4.md) | | |
| Up | *[A Dance in Fire](https://en.uesp.net/wiki/Skyrim:A_Dance_in_Fire)* | | |
| Prev. | *[Chapter 3](Skyrim_A_Dance_in_Fire,_v3.md)* | Next | *[Chapter 5](Skyrim_A_Dance_in_Fire,_v5.md)* |
...
| Locations | | | |
| Found in the following locations: - [Ilinalta's Deep](Skyrim_Ilinalta%27s_Deep.md), on a bookshelf in the southeastern room <br> - [Lost Knife Hideout](https://en.uesp.net/wiki/Skyrim:Lost_Knife_Hideout), on a bookshelf just before the cages <br> - [Fort Amol Prison](Skyrim_Fort_Amol.md), on the bookshelves to the left of the entrance <br> - [Jala's House](Skyrim_Jala%27s_House.md), can be one of the books that randomly spawns in the knapsack to the right of the entrance | | | |

[A Dance in Fire](https://en.uesp.net/wiki/Skyrim:A_Dance_in_Fire)
Chapter 4 **by [Waughin Jarth](Lore_Books_by_Author.md#Waughin_Jarth)** *Chapter 4 of a clerk's adventures in Valenwood*
---
