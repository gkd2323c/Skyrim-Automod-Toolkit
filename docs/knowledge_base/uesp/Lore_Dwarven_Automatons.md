...
| Book Information | | | |
| --- | --- | --- | --- |
| Seen In: | - [Skyrim](Skyrim_Herbane%27s_Bestiary__Automatons.md) <br> - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Dwarven_Automatons) | | |
| Up | *[Herbane's Bestiary](Lore_Herbane%27s_Bestiary.md)* | | |
| Prev. | None | Next | *[Hagravens](Lore_Herbane%27s_Bestiary__Hagravens.md)* |

Herbane's Bestiary:
Dwarven Automatons **by [Herebane](Lore_Books_by_Author.md#Herbane)** *A guide to Dwemer Constructs*
---
The title of the Skyrim version of this book spells the author's name as Herbane. The text itself references Herebane, and there are several items using the name Herebane present in Skyrim. In the ESO version of this book, the author is specifically cited with the spelling Herebane. As the only usage of the Herbane spelling is in the title of the books in Skyrim, it seems likely that this is a mistake and the author's name is intended to be Herebane.
