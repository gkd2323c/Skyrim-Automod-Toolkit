...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:A_Request_for_Relief) |

A Request for Relief **by [Defessus Magister](Lore_Books_by_Author.md#Defessus_Magister)** *An enchanter's plea regarding manufactured glyphs and the collapse of the enchanting market*
---
My dear Exchequer,

I once again implore you to revisit the levy that has been placed upon myself for this year. I admit that I am a licensed [enchanter](Lore_Enchanting.md) residing inside the [Imperial City](Lore_Imperial_City.md). But circumstances have changed, and the business that was once profitable, is now just a drain on my income.
...
Seems simple, doesn't it? Well, this has caused a collapse of the market. Instead of the price for an enchantment being set on a city-by-city basis, all of the enchanters of [Tamriel](Lore_Tamriel.md) have to compete with each other. A hedge enchanter in [Daggerfall](Lore_Daggerfall.md) can make ten fire glyphs and sell them to a traveling merchant, who brings them to the Imperial City and sells them in the marketplace, at a price much below the price set by the [Cyrodilic](Lore_Cyrodiil.md) enchanters.
