...
A fairly empty room with a large grating on the floor and single, half-sized "harmless" [Gnarl](Lore_Gnarl.md) wandering in the center.

- Manic Result

Our small, harmless Gnarl will be grown in size to nearly thrice that of the average Xedilianite. Most we observe run around in an attempt to escape the lumbering creature. Eventually, it will stop and fade away. The [magic](Lore_Magic.md) of the room is enhanced by the spore gas we pump in through the grating.
