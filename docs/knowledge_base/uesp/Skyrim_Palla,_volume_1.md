...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Basic Book6.png) Book Information <br> *Palla, volume 1* | | | |
| --- | --- | --- | --- |
| [ID](Skyrim_Form_ID.md) | 00 01AFFE | | |
| See Also | [Lore version](Lore_Palla,_volume_1.md) | | |
| Up | *[Palla](Skyrim_Palla.md)* | | |
| Prev. | None | Next | *[Volume 2](Skyrim_Palla,_volume_2.md)* |
...
| Locations | | | |
| Found in the following locations: - [Fellglow Keep Dungeons](Skyrim_Fellglow_Keep.md#Fellglow_Keep_Dungeons), on a shelf <br> - [Lost Knife Hideout](Skyrim_Lost_Knife_Hideout.md), on a bookshelf just before the cages | | | |

Palla, volume 1 **by [Vojne Mierstyyd](Lore_Books_by_Author.md#Vojne_Mierstyyd)** *A conjurer's tragic infatuation with a dead woman (volume 1 of 2)*
---
