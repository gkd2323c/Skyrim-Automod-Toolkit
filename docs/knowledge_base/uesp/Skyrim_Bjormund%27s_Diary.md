...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Journal1.png) Book Information <br> *Bjormund's Diary* | | | |
| --- | --- | --- | --- |
| Added by | [Alternative Armors - Dragon Plate](Skyrim_Alternative_Armors_-_Dragon_Plate.md) | | |
| [ID](Skyrim_Form_ID.md) | FE [xxx](Skyrim_Form_ID.md#Creation_Club) 81B | | |
...
| Related to | [Bones for a Crow](Skyrim_Bones_for_a_Crow.md) | | |
| Locations | | | |
| Found in the following locations: - [Arcwind Point](Skyrim_Arcwind_Point.md) | | | |

Bjormund's Diary **by [Bjormund Wind-Strider](Skyrim_Bjormund_Wind-Strider.md)** *The recounting of an encounter with Dragonbone Mail*
---
