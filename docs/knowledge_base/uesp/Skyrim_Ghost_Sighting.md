...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Note1.png) Book Information <br> *Ghost Sighting* | | | |
| --- | --- | --- | --- |
| Added by | [Spell Knight Armor](Skyrim_Spell_Knight_Armor.md) | | |
| [ID](Skyrim_Form_ID.md) | FE [xxx](Skyrim_Form_ID.md#Creation_Club) 838 | | |
...
| Locations | | | |
| Found in the following locations: - [<sup>(?)</sup>](https://en.uesp.net/wiki/Category:Pages_Missing_Data) | | | |

Ghost Sighting *The story of a ghost that haunts the River Karth*
---
