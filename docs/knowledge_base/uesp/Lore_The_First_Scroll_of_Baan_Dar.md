...
| Book Information | |
| --- | --- |
| Seen In: | - [Daggerfall](https://en.uesp.net/wiki/Daggerfall:The_First_Scroll_of_Baan_Dar) <br> - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:First_Scroll_of_Baan_Dar_(Excerpt)) |

The First Scroll of Baan Dar **by [Arkan](Lore_Books_by_Author.md#Arkan)** *A book about the true Baan Dar, God and Man*
---
*Note: A slightly different version of this book is found in the * [Daggerfall Preview](https://en.uesp.net/wiki/Daggerfall:Daggerfall_Preview) *: * [The First Scroll of Bajdit](https://en.uesp.net/wiki/Daggerfall:Daggerfall_Preview/The_First_Scroll_of_Bajdit) *.*

---
*What follows is a translation of the first fragment from a series of vellum scrolls found in three Alabaster jars sealed in a cave. The discoverer was a nomad wanderer somewhere on the shores of [Lake Vread](Lore_Lake_Vread.md) in the Province of [Elswyer](Lore_Elsweyr.md)* [[sic](https://en.uesp.net/wiki/UESPWiki:Spelling#Books_and_Direct_Quotes)] *. I can neither vouch for nor deny its authenticity or veracity - only that the scrolls, as such, do exist. Read and judge for yourself:*

[Baan Dar](Lore_Baan_Dar.md), The Legend...Thief, Warlock, Shadowmaster, Ruthless Assassin, Undying Avenger, Dark God, Robber Baron, Mastermind of Nefarious Plots. All these things and more are the Legendary Baan Dar, he who is called The Bandit God; but what is the Truth?
...
- Arkan, Scribe of [Daggerfall](Lore_Daggerfall.md) in the year [2E 24](Lore_Second_Era.md#2E_24)