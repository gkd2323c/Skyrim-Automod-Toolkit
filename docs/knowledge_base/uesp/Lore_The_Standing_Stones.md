...
| Book Information | |
| --- | --- |
| Seen In: | - [Shivering Isles](https://en.uesp.net/wiki/Shivering:The_Standing_Stones) |

The Standing Stones **by Anonymous** *A brief history and description of the Shivering Isles' Obelisks of Order*
---
Any visitor to the [Shivering Isles](Lore_Shivering_Isles.md) will soon come across the dreadful shape of a tall, crystalline stone looming over them like an accusing finger. Variously known as standing stones or obelisks, they cannot be avoided in traveling the Shivering Isles, no matter how hard you might try.
