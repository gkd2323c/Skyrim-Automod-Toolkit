...
| Seen In: | - [Morrowind](https://en.uesp.net/wiki/Morrowind:Palla,_Book_II) <br> - [Oblivion](https://en.uesp.net/wiki/Oblivion:Palla,_volume_2) <br> - [Skyrim](https://en.uesp.net/wiki/Skyrim:Palla,_volume_2) | | |
| Up | *[Palla](Lore_Palla.md)* | | |
| Prev. | *[Volume 1](Lore_Palla,_volume_1.md)* | Next | None |

[Palla](Lore_Palla.md), volume 2 **by [Vojne Mierstyyd](Lore_Books_by_Author.md#Vojne_Mierstyyd)** *A conjurer's tragic infatuation with a dead woman (volume 2 of 2)*
---
