...
| [](https://en.uesp.net/wiki/File:SR-icon-book-The_Betrayed.png) Book Information <br> *Diary of Faire Agarwen* | | | |
| --- | --- | --- | --- |
| Added by | [Dawnguard](Skyrim_Dawnguard.md) | | |
| [ID](Skyrim_Form_ID.md) | [xx](Skyrim_Form_ID.md) 01A3E7 | | |
| See Also | [Lore version](Lore_Diary_of_Faire_Agarwen.md) | | |
...
| Note | | | |
| The original text has the title [Unknown Book, Vol. III](https://en.uesp.net/wiki/Skyrim:Unknown_Book,_Vol._III). | | | |

Diary of Faire Agarwen **by [Faire Agarwen](Lore_Books_by_Author.md#Faire_Agarwen)** *The ancient diary of a Snow Elf lamenting the extermination of their race*
---

### Forward *[[sic](https://en.uesp.net/wiki/UESPWiki:Spelling#Books_and_Direct_Quotes)]*
