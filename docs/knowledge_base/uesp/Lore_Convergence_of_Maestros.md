...
| Book Compilation | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Convergence_of_Maestros) |
| Note | |
| This is a compilation of books assembled for easier reading. | |

Convergence of Maestros **by [Hartlin Treg](Lore_Books_by_Author.md#Hartlin_Treg)** *Meeting minutes from a Maestro summit*
---

## *[Volume 1](Lore_Convergence_of_Maestros,_Volume_1.md)*
Convergence of [Bards College](Lore_Bards_College.md) Maestros
[Solitude](Lore_Solitude.md), [2E 580](Lore_Second_Era.md#2E_580)
First [Loredas](https://en.uesp.net/wiki/Lore:Loredas) of [Hearthfire](Lore_Hearthfire.md)

In Attendance:
~ [Headmaestro Catrelle Georick](https://en.uesp.net/wiki/Lore:Headmaestro_Catrelle_Georick)
...
~ Honorable [Yngmaer Raven-Quill](Lore_Yngmaer_Raven-Quill.md), Historian Royal
~ Honorable [Helgreir Lute-Voice](Lore_Helgreir_Lute-Voice.md), Bard Royal of [Windhelm](Lore_Windhelm.md), representing [Jorunn the Skald-King](Lore_Jorunn.md)
~ Adjunct Professor Twains-the-Nigh, Professor of [Argonian](Lore_Argonian.md) Music Theory
~ Master Maestro Alumnus Nel Farsong
~ Assistant to the Headmaster and Scribe, [Hartlin Treg](Lore_Books_by_Author.md#Hartlin_Treg) (Me)
...
Catrelle: Stop being so dramatic! [Tamriel](Lore_Tamriel.md)'s bards look to us to make mature decisions for the culture of bards as a whole. Act like you deserve the honor!

Twains-the-Night: If you truly mean all bards, then let me be the Argonian representative to express my dismay in your needs to preserve everything in a world where all things eventually return to [Nirn](Lore_Nirn.md). In our land, nothing survives time or the marsh. We make use of everything, and if something has no use, we commit it again to the swamp.
...
## *[Volume 2](Lore_Convergence_of_Maestros,_Volume_2.md)*
Convergence of [Bards College](Lore_Bards_College.md) Maestros
[Solitude](Lore_Solitude.md), [2E 580](Lore_Second_Era.md#2E_580)
First [Loredas](https://en.uesp.net/wiki/Lore:Loredas) of [Hearthfire](Lore_Hearthfire.md)
...
Helgrier: As the emissary of Jorunn the Skald-King, I believe I have the authority to proclaim these instruments to be [Skyrim](Lore_Skyrim.md)'s treasures, to be preserved—
...
Viatrix: Where we can appreciate their beauty and history without the grubby paws of lusty bards snapping strings or splitting drum heads trying to be the next [Calissos](Lore_Callisos.md).
