...
| Book Information | |
| --- | --- |
| Seen In: | - [Skyrim](https://en.uesp.net/wiki/Skyrim:The_Code_of_Malacath) |

The Code of Malacath: A Sellsword's Guide to the Orc Strongholds **by [Amanda Alleia](Lore_Books_by_Author.md#Amanda_Alleia), Mercenary** *A description of life in an average Orc Stronghold*
---
*Note: A similar but not identical version of this book appeared in [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Online). For that version, see [The Code of Mauloch](Lore_The_Code_of_Mauloch.md).*

---
"No one bests an [Orc](Lore_Orc.md)."
