...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Arx_Corinium_%E2%80%94_First_Seed_Report) |

Arx Corinium — First Seed Report **by [Centurion Pontius](Lore_Books_by_Author.md#Centurion_Pontius)** *An Imperial officer's journal outlining the difficulties in the construction of Arx Corinium*
---
Officer's Log: Centurion Pontius

Building a fort in a swamp is no trivial task, but my men and I have accomplished it with Arx Corinium. It was a battle the entire duration—with insect-borne disease, with the wildlife of the [marshlands](Lore_Black_Marsh.md), but the [Empire](Lore_Empire.md) wanted a foothold in this region and we provided one.
...
Construction suffered numerous complications: the bog impeded our progress at every turn, and it became clear the initial foundation we built would sink after the first month. When we moved our location farther to the north, we met a fierce [wamasu](Lore_Wamasu.md) that cost me ten men to chase off the premises. After repeated encounters, our war wizard, Belisaro, named it Ganakton the Tempest, after the bolts of lightning that the beast emits from every orifice ("Ganakton" was the moniker of a hated aunt, rumored to possess [Orcish](Lore_Orc.md) blood).
