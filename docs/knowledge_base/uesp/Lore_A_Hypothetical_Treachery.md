...
| Seen In: | - [Morrowind](https://en.uesp.net/wiki/Morrowind:A_Hypothetical_Treachery) <br> - [Oblivion](https://en.uesp.net/wiki/Oblivion:A_Hypothetical_Treachery) <br> - [Skyrim](Skyrim_A_Hypothetical_Treachery.md) <br> - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:A_Hypothetical_Treachery) |

A Hypothetical Treachery **by [Anthil Morvir](Lore_Books_by_Author.md#Anthil_Morvir)** *A One Act Play*
---
*This book had a companion image on the official Elder Scrolls website, [archived here](https://en.uesp.net/wiki/File:LO-book-A_Hypothetical_Treachery.jpg).*

---

- Dramatis Personae
- - **Malvasian:** A [High Elf](Lore_Altmer.md) battlemage
- - **Inzoliah:** A [Dark Elf](Lore_Dunmer.md) battlemage
- - **Dolcettus:** A [Cyrodiil](Lore_Imperial.md) healer
- - **Schiavas:** An [Argonian](Lore_Argonian.md) barbarian
- - **A [Ghost](Lore_Ghost.md)**
- - **Some bandits**
- **Scene: Eldenwood**
...
SCHIAVAS: If I carried that, my hands would be too full to fight. And tell me if I'm wrong, but not one of the three of you has enough [magicka](Lore_Magic.md) reserved to make it out of here alive. Not after you electrified and blasted all those [homunculuses](https://en.uesp.net/wiki/Lore:Homunculus) down below ground.
...
SCHIAVAS: Kill you all and take the [Ebony Mail](Lore_Ebony_Mail.md) for myself. Admit it -- you thought I had that in mind.
...
INZOLIAH: It's probably a [wolf](Lore_Wolf.md). These woods are filled with them. You check it out.
