...
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Guild_Memo_on_Soul-Trapping) |

Guild Memo on Soul-Trapping **by [Vanus Galerion](Lore_Vanus_Galerion.md), Archmagister Emeritus** *Vanus Galerion's proposal on the use of soul-trapping magics*
---
[Mages Guild](Lore_Mages_Guild.md) Memorandum: Confidential, Magisters Only

From [Vanus Galerion](Lore_Vanus_Galerion.md), Archmagister Emeritus
...
There are reasons why soul-trapping has never been part of the core curriculum of the Mages Guild, taught to only the most experienced and dependable wizards, and then only for certain specific uses. First of all, it is technically a subset of [necromancy](Lore_Necromancy.md), and on that basis alone it should be abhorred. (Except, as mentioned, for certain special cases, and then only under controlled conditions.) Second, it is a magical technology that practically invites abuse, especially when employed to trap the souls of sentient mortals. It is the sort of arcane practice that the public fears most, and is likely to result in local bans on the organized teaching of [magic](Lore_Magic.md), and if that happens all our work in establishing the Guild will have been in vain.

The fact that soul-trapping is now common knowledge among [Tamriel](Lore_Tamriel.md)'s magery, to the point where so-called "Mystics" sell [soul gems](Lore_Soul_Gem.md) of various sizes in every market and bazaar, is a problem that can be laid squarely at the feet of the iniquitous [Mannimarco](Lore_Mannimarco.md) and his [Order of the Black Worm](Lore_Order_of_the_Black_Worm.md). It is all part of his program to make necromancy seem commonplace and almost harmless. In some parts of Tamriel, notably Cyrodiil, the vile practice of necromancy has even become accepted as a valid, and legally tolerated, magical discipline. What our old mentor [Iachesis](Lore_Iachesis.md) would have to say about this pernicious development I hate to think.
