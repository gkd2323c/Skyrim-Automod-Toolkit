...
| Seen In: | - [Morrowind](https://en.uesp.net/wiki/Morrowind:The_Dowry) <br> - [Oblivion](https://en.uesp.net/wiki/Oblivion:More_Than_Mortal) <br> - [Skyrim](https://en.uesp.net/wiki/Skyrim:The_Dowry) <br> - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Ancient_Scrolls_of_the_Dwemer_X) | | |
| Up | *[Ancient Tales of the Dwemer](Lore_Ancient_Tales_of_the_Dwemer.md)* | | |
| Prev. | *[Part VIII](Lore_The_Snow_Elf_and_the_Variation-Lens.md)* | Next | *[Part XI](Lore_Azura_and_the_Box.md)* |

[Ancient Tales of the Dwemer](Lore_Ancient_Tales_of_the_Dwemer.md), Part X: The Dowry **by [Marobar Sul](Lore_Books_by_Author.md#Marobar_Sul)** *Book 10 of a series of fictional stories about the Dwemer*
---
*In Oblivion, this book appears under the name "More than Mortal" but it is otherwise identical in text to this book.*
