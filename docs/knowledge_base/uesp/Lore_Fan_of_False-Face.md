...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Fan_of_False-Face) ([Summerset](https://en.uesp.net/wiki/Online:Summerset_(Chapter))) |

Fan of False-Face **by [Speaker Gilzaron](Lore_Books_by_Author.md#Speaker_Gilzaron)** *Instruction on how to use an identity-stealing artifact*
---
