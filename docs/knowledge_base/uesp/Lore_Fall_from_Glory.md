...
| --- | --- |
| Seen In: | - [Skyrim](https://en.uesp.net/wiki/Skyrim:Fall_from_Glory) |

Fall from Glory **by [Nithilis Lidari](Lore_Books_by_Author.md#Nithilis_Lidari)** *Theories on the weakening of the Skyrim Thieves Guild*
---
The [Thieves Guild](Lore_Thieves_Guild.md) of [Skyrim](Lore_Skyrim.md) is something of an enigma. Within the last few decades, their order has gone from one of the largest, most influential criminal organizations in all of [Tamriel](Lore_Tamriel.md) to a small group of stragglers barely able to wreak havoc in their home city of [Riften](Lore_Riften.md). Although evidence that could explain this rapid decline has never surfaced, speculation has run rampant.

One theory holds that the Guild suffered a loss - it's strongly believed that their Guild Master was slain by one of their own. This Guild Master, known only as "[Gallus](https://en.uesp.net/wiki/Lore:Gallus)," maintained strong ties with many of the influential families in Skyrim. When he perished, those bonds perished with him. Without these bonds, the Guild could no longer safely operate within Skyrim's [holds](Lore_Hold.md).
