...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Basic Book2.png) Book Information <br> *The Real Barenziah, v5* | | | |
| --- | --- | --- | --- |
| [ID](Skyrim_Form_ID.md) | 00 01ACDA | | |
| See Also | [Lore version](Lore_The_Real_Barenziah,_v_5.md) | | |
| Up | *[The Real Barenziah](Skyrim_The_Real_Barenziah.md)* | | |
| Prev. | *[Volume 4](Skyrim_The_Real_Barenziah,_v4.md)* | Next | None |
...
| Locations | | | |
| Found in the following locations: - [Fellglow Keep](Skyrim_Fellglow_Keep.md), two copies on shelves in the room with the Flame Atronach <br> - [Lost Knife Hideout](Skyrim_Lost_Knife_Hideout.md), on a bookshelf just before the cages <br> - [Mistwatch](Skyrim_Mistwatch.md), East tower on a bookshelf to the right of the entrance | | | |

[The Real Barenziah](Skyrim_The_Real_Barenziah.md)
Volume Five **by Anonymous** *Unauthorized biography of the famous Queen Mother of Morrowind, Volume 5* *
---
*Note: This is part of the revised series of books that appeared in [Morrowind](https://en.uesp.net/wiki/Morrowind:Morrowind), [Oblivion](https://en.uesp.net/wiki/Oblivion:Oblivion), and [Skyrim](Skyrim_Skyrim.md). In [Daggerfall](https://en.uesp.net/wiki/Daggerfall:Daggerfall), this content appears in * [The Real Barenziah, Part IX](Lore_The_Real_Barenziah,_Part_IX.md) * and * [The Real Barenziah, Part X](Lore_The_Real_Barenziah,_Part_X.md) *, although somewhat shortened. The only apparent difference between this version and that in Oblivion and Morrowind is one minor correction ("twenty years later" instead of "twenty years before").*
