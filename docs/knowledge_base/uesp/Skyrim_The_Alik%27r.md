...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Basic Book5.png) Book Information <br> *The Alik'r* | | | |
| --- | --- | --- | --- |
| Added by | [Redguard Elite Armaments](Skyrim_Redguard_Elite_Armaments.md) | | |
| [ID](Skyrim_Form_ID.md) | FE [xxx](Skyrim_Form_ID.md#Creation_Club) 83D | | |
| See Also | [Lore version](Lore_The_Alik%27r.md) | | |
| [![Value](https://images.uesp.net/thumb/5/52/SR-item-Gold-heads.png/22px-SR-item-Gold-heads.png)](https://en.uesp.net/wiki/File:SR-item-Gold-heads.png) | 4 | [](https://en.uesp.net/wiki/File:SR-icon-clothing-Leather_Backpack_(square).png) | 1.0 |
| Related to | [Interception](Skyrim_Interception.md) | | |
| Writer | [Ted Peterson](https://en.uesp.net/wiki/General:Ted_Peterson) | | |
| Locations | | | |
| Found in the following locations: - South of [Sunderstone Gorge](Skyrim_Sunderstone_Gorge.md), on the back of a wagon | | | |
...
might never have gone to the [Alik'r](Skyrim_Alik%27r.md) Desert had I not met [Weltan](Lore_Weltan.md) in a little tavern in [Sentinel](Lore_Sentinel.md). Weltan is a [Redguard](Skyrim_Redguard.md) poet whose verse I had read, but only in translation. He chooses to write in the old language of the Redguards, not in Tamrielic. I once asked him why.
