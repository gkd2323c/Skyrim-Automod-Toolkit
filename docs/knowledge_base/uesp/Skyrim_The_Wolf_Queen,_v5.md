...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Basic Book2a.png) Book Information <br> *The Wolf Queen, v5* | | | |
| --- | --- | --- | --- |
| [ID](Skyrim_Form_ID.md) | 00 01B024 | | |
| See Also | [Lore version](Lore_The_Wolf_Queen,_v5.md) | | |
| Up | *[The Wolf Queen](Skyrim_The_Wolf_Queen.md)* | | |
| Prev. | *[Book Four](Skyrim_The_Wolf_Queen,_v4.md)* | Next | *[Book Six](Skyrim_The_Wolf_Queen,_v6.md)* |
...
| Locations | | | |
| Found in the following locations: - [Bloodlet Throne](Skyrim_Bloodlet_Throne.md) (two copies) <br> - [Fort Amol Prison](Skyrim_Fort_Amol.md), on the ground to the right of the entrance <br> - [Viola Giordano's House](Skyrim_Viola_Giordano%27s_House.md), on the bookshelf in the main room <br> - [Riften Jail](Skyrim_Riften_Jail.md), one copy on the cupboard by the cells and another on the shelves up the stairs | | | |

The Wolf Queen, v5 **by [Waughin Jarth](Lore_Books_by_Author.md#Waughin_Jarth)** *Life of Queen Potema, Book Five* *
---
