...
| Book Information | |
| --- | --- |
| Seen In: | - [Skyrim](Skyrim_Catalogue_of_Weapon_Enchantments.md) |

Complete Catalogue of Enchantments for Weaponry **by [Yvonne Bienne](Lore_Books_by_Author.md#Yvonne_Bienne), [Synod](Lore_Synod.md) researcher** *An incomplete list of all the spells and weapons used in enchanting*
---
...
[Weapon](Lore_Weapons.md) *[[sic](https://en.uesp.net/wiki/UESPWiki:Spelling#Books_and_Direct_Quotes)]* such as axes and bows can hold a wide variety of enchantments. The most common are fire, frost and lightning. The simple, yet effective enchantments burn, freeze or shock when they draw blood.
