...
| Seen In: | - [Morrowind](https://en.uesp.net/wiki/Morrowind:Azura_and_the_Box) <br> - [Oblivion](https://en.uesp.net/wiki/Oblivion:Azura_and_the_Box) <br> - [Skyrim](Skyrim_Azura_and_the_Box.md) <br> - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Ancient_Scrolls_of_the_Dwemer_XI) | | |
| Up | *[Ancient Tales of the Dwemer](Lore_Ancient_Tales_of_the_Dwemer.md)* | | |
| Prev. | *[Part X](Lore_The_Dowry.md)* | Next | None |

[Ancient Tales of the Dwemer](Lore_Ancient_Tales_of_the_Dwemer.md), Part XI: Azura and the Box **by [Marobar Sul](Lore_Books_by_Author.md#Marobar_Sul)** *Book 11 of a series of fictional stories about the Dwemer*
---
