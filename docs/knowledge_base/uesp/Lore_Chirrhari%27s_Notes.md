...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Chirrhari%27s_Notes) ([Clockwork City](https://en.uesp.net/wiki/Online:DLC#Clockwork_City)) |

Chirrhari's Notes **by [Apprentice Chirrhari](Lore_Books_by_Author.md#Apprentice_Chirrhari)** *Research notes of the types of fungi grown in the Everwound Wellspring*
---
Warning: Reactions with [Clockwork City](Lore_Clockwork_City.md) soil may radically change a mushroom strain's expected properties. Only imbibe fungi after extensive testing using [fabricant](Lore_Fabricant.md) subjects. As the saying goes, you can eat all mushrooms, but some only once.

Strain A-01-K:
Large, flat caps, red. One stalk in cluster always white. Subject exhibited difficulty keeping balance after eating sample. Three gear clicks later, subject charged in unpredictable directions, often losing its balance while doing so. This resulted in a short delay in experimentation as [factotums](Lore_Factotum.md) repaired damage to nearby equipment.
