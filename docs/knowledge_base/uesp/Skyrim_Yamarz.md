...
| Chief Yamarz <br> (Ref ID: 00 03BC27) | | | |
| --- | --- | --- | --- |
| Stronghold | [Largashbur](Skyrim_Largashbur.md) | | |
| House | [Largashbur Longhouse](Skyrim_Largashbur_Longhouse.md) | | |
| Race | [Orc](Skyrim_Orc.md) | Gender | Male |
| Level | PC×1 (range=6-20) | Class | [Orc Warrior](Skyrim_Orc_Warrior.md) |
| [Ref ID](Skyrim_NPCs.md#Console_IDs) | 00 03BC27 | [Base ID](Skyrim_NPCs.md#Console_IDs) | 00 03BC26 |
| Other Information | | | |
| [Health](Skyrim_Health.md) | 1050+(PC-1)×11.7 | | |
| [Magicka](Skyrim_Magicka.md) | 50+(PC-1)×3.3 | | |
| [Stamina](Skyrim_Stamina.md) | 50 | | |
| Primary [Skills](Skyrim_Skills.md) | **[Heavy Armor](Skyrim_Heavy_Armor.md)**, **[One-handed](Skyrim_One-handed.md)**, [Archery](Skyrim_Archery.md), [Sneak](Skyrim_Sneak.md) | | |
| Class Details | [Guard Orc1H](Skyrim_GuardOrc1H.md) | | |
| [Morality](Skyrim_Morality.md) | No Crime | [Aggression](Skyrim_Aggression.md) | Aggressive |
| [Essential](Skyrim_Essential_NPCs.md) | Yes, until stage 90 of The Cursed Tribe | | |
| Voice Type | [Male Orc](https://en.uesp.net/wiki/Category:Skyrim-Voice-Male Orc) | | |
| [Faction(s)](Skyrim_Factions.md) | [Blood-Kin of the Orcs](Skyrim_Blood-Kin_of_the_Orcs.md); [Favor Excluded Faction](Skyrim_FavorExcludedFaction.md); [Guard Faction](Skyrim_Guard Faction_(makes_an_actor_a_guard).md); [Job Orc Chief Faction](Skyrim_JobOrcChiefFaction.md); [Town Largashbur Faction](Skyrim_TownLargashburFaction.md); [Tribal Orcs](Skyrim_Tribal_Orcs.md) | | |

[![](https://images.uesp.net/thumb/e/e3/SR-npc-Chief_Yamarz.jpg/200px-SR-npc-Chief_Yamarz.jpg)](https://en.uesp.net/wiki/File:SR-npc-Chief_Yamarz.jpg) [](https://en.uesp.net/wiki/File:SR-npc-Chief_Yamarz.jpg) Chief Yamarz **Chief Yamarz** is an [Orc](Skyrim_Orc.md) [warrior](Skyrim_GuardOrc1H.md) and the chief of the accursed [Orc stronghold](Skyrim_Orc_Strongholds.md) of [Largashbur](Skyrim_Largashbur.md), located in [the Rift](Skyrim_The_Rift.md), east of [Avanchnzel](Skyrim_Avanchnzel.md). He is generally unpleasant and displays many traits not normally associated with Orcs such as a conniving nature and an aversion to battle. It is never fully explained why [Malacath](Lore_Malacath.md) cursed his tribe, but it's implied that Yamarz's weaknesses as leader are a reflection of the curse itself. This would help explain why Malacath charges Yamarz alone with the task of slaying the leader of the [giant](Skyrim_Giant.md) tribe that has defiled his shrine.

Yamarz is clad in a complete set of Orcish equipment. This includes the [cuirass](Skyrim_Orcish_Armor.md), a pair of [gauntlets](Skyrim_Orcish_Gauntlets.md), a pair of [boots](Skyrim_Orcish_Boots.md), and a [helmet](Skyrim_Orcish_Helmet.md). He is equipped with a leveled [war axe](Skyrim_War_Axe.md) and a leveled [shield](Skyrim_Shield.md), both of which can be up to Orcish quality.

## Related Quests
- **[The Cursed Tribe](Skyrim_The_Cursed_Tribe.md)**: Help lift the curse placed on the [Orcs](Skyrim_Orc.md) of [Largashbur](Skyrim_Largashbur.md) by [Malacath](Lore_Malacath.md).
...
As you enter the [Largashbur Longhouse](Skyrim_Largashbur_Longhouse.md) with Atub:
...
## Bugs
- If Yamarz is kept pacified, The Cursed Tribe will still complete but won't acknowledge he is still alive. - ![PC Only](https://images.uesp.net/d/d7/Computer.svg)
The [Unofficial Skyrim Patch](https://en.uesp.net/wiki/Skyrim_Mod:Unofficial_Skyrim_Patch), version 1.2.7, addresses this issue. Magic effect `Influence Agg Down FFAimed Area` has been modified to make Yamarz immune to Pacify and other spells which use this effect.
- Yamarz's sleep package can't activate due to it being blocked by his general sandbox package. - ![PC Only](https://images.uesp.net/d/d7/Computer.svg)
The [Unofficial Skyrim Patch](https://en.uesp.net/wiki/Skyrim_Mod:Unofficial_Skyrim_Patch), version 2.0.4, fixes this bug.
- When Yamarz says "It's not the only thing in Fallowstone Cave", the actual audio instead states "It's not the only thing in **the** Fallowstone Cave". - ![PC Only](https://images.uesp.net/d/d7/Computer.svg)
The [Unofficial Skyrim Patch](https://en.uesp.net/wiki/Skyrim_Mod:Unofficial_Skyrim_Patch), version 2.0.4, fixes this bug.