...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Basic Book2a.png) Book Information <br> *An Accounting of the Scrolls* | | | |
| --- | --- | --- | --- |
| [ID](Skyrim_Form_ID.md) | 00 0ED03A | | |
| See Also | [Lore version](Lore_An_Accounting_of_the_Scrolls.md) | | |
