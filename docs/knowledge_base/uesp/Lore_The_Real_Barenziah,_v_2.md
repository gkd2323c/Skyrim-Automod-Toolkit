...
| Seen In: | - [Morrowind](https://en.uesp.net/wiki/Morrowind:The_Real_Barenziah_v_II) <br> - [Oblivion](https://en.uesp.net/wiki/Oblivion:The_Real_Barenziah,_v_2) <br> - [Skyrim](https://en.uesp.net/wiki/Skyrim:The_Real_Barenziah,_v2) | | |
| Up | *[The Real Barenziah](Lore_The_Real_Barenziah.md)* | | |
| Prev. | *[Volume 1](Lore_The_Real_Barenziah,_v_1.md)* | Next | *[Volume 3](Lore_The_Real_Barenziah,_v_3.md)* |

[The Real Barenziah](Lore_The_Real_Barenziah.md), Part 2 **by Anonymous** *Unauthorized biography of the famous Queen Mother of Morrowind, Volume 2*
---
