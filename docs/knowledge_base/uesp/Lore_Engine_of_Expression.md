...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Engine_of_Expression) ([Clockwork City](https://en.uesp.net/wiki/Online:Clockwork_City_(DLC))) |

Engine of Expression **by [Proctor Albacron](Lore_Books_by_Author.md#Proctor_Albacron), Second Innovator of the Sacred Flywheel** *A collection of Clockwork Apostle idioms related to the Great Gear concept*
---
The Great Gear, a concept first put forth by Lord [Sotha Sil](Lore_Sotha_Sil.md) and later expanded upon by his [Clockwork Apostles](Lore_Clockwork_Apostles.md), illustrates the idea that all of existence can be expressed as the workings of a finely tuned machine. The Great Gear represents nature's primal engine, the source of life and power that makes [Nirn](Lore_Nirn.md) thrive. It isn't a literal engine. The Father of Mysteries used the metaphorical idea of a primal engine to expound upon his teachings and philosophy. The apostles that learned from Lord Seht followed his example and built upon the metaphor to create a rich and expressive manner of speaking that sets them apart from other followers of the [Tribunal](Lore_Tribunal.md).
