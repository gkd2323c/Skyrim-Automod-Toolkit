...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Alchemy_Practicum) |

Alchemy Practicum **by [Defessus Lector](Lore_Books_by_Author.md#Defessus_Lector)** *A reminder on the proper way to create new potions*
---
Bardus,

The traditional approach for a novice [alchemist](Lore_Alchemy.md) to learn how to concoct potions is to experiment. This means systematically trying a mix of carefully selected reagents in a solvent, and observing the results. Then you change one of the reagents and see if you get different results.
