...
| Book Information | |
| --- | --- |
| Seen In: | - [Battlespire](https://en.uesp.net/wiki/Battlespire:Arcana_Restored:_A_Handbook) <br> - [Morrowind](https://en.uesp.net/wiki/Morrowind:Arcana_Restored) <br> - [Oblivion](https://en.uesp.net/wiki/Oblivion:Arcana_Restored) <br> - [Skyrim](Skyrim_Arcana_Restored.md) <br> - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Arcana_Restored) |

Arcana Restored
A Handbook **by [Wapna Neustra](Lore_Books_by_Author.md#Wapna_Neustra)
Praeceptor Emeritus** *Cryptic instructions for the restoration of Arcana*
---
*Note: In [Battlespire](https://en.uesp.net/wiki/Battlespire:Battlespire), Wapna Neustra's full title is "Praeceptor Emeritus of the Imperial College".*
