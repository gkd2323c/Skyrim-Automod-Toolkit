...
### Merchant Chests
[Merchant Chests](https://en.uesp.net/wiki/Skyrim:Merchant_Chest) respawn every two days (48 hours) of in-game time, independent of whether the store or cell containing the chest has respawned.
...
## See Also
- [Cell Reset](https://en.uesp.net/wiki/Cell:Reset) on the Creation Kit wiki.
...
The [Unofficial Skyrim Patch](https://en.uesp.net/wiki/Skyrim:Mod_Unofficial_Skyrim_Patch), version 2.1.2, fixes this bug. ([details](https://afktrack.afkmods.com/index.php?a=issues&i=19112))