...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:A_Clothier%27s_Primer) |

A Clothier's Primer **by [the Shattered Masque](Lore_Books_by_Author.md#The_Shattered_Masque)** *A beginner's guidebook to crafting reliable footwear*
---
...
- This basic primer will teach you how to make a simple pair of homespun shoes. If we're to face each other in the Blessed Crucible, I want you to fall because of my unmatched skill—not your pathetic boot stitching.

#### Step 1: Acquire Jute

- [Raw jute](https://en.uesp.net/wiki/Lore:Jute) is cheap, plentiful, and easy to weave. Look for the distinctive yellow flowers in the wild. I suppose you could pay someone to pick them for you, and it's that kind of laziness I look forward to punishing in the arena.
...
- Clothiers from all across [Tamriel](Lore_Tamriel.md) have their own cultural style. You need style to make an impression in the dueling ring, so find the style material that's easiest for you to work. If you're a/an [Player's race], start with material for the [Player's race] style. Purchase it from clothiers or take them from your whimpering, defeated enemies.
