...
| Seen In: | - [Daggerfall](https://en.uesp.net/wiki/Daggerfall:The_Real_Barenziah,_Part_IX) | | |
| Up | *[The Real Barenziah](Lore_The_Real_Barenziah_(Daggerfall).md)* | | |
| Prev. | *[Part 8](Lore_The_True_Barenziah,_Part_VIII.md)* | Next | *[Part 10](Lore_The_Real_Barenziah,_Part_X.md)* |

[The Real Barenziah](Lore_The_Real_Barenziah_(Daggerfall).md) Part IX **by [Anonymous](Lore_Books_by_Author.md#Plitinius_Mero)** *Part 9 of an unauthorized biography of the famous Dark Elf Queen of Wayrest*
---
*Note: This is part of the original, uncensored series of books that appeared in * [Daggerfall](https://en.uesp.net/wiki/Daggerfall:Daggerfall) *. In subsequent games, this content appears in * [The Real Barenziah, v 5](Lore_The_Real_Barenziah,_v_5.md) * with some minor modifications.*
