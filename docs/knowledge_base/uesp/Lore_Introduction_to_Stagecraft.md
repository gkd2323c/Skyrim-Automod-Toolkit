...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Introduction_to_Stagecraft) |

Introduction to Stagecraft **by [Kandelwijj the Magnificent](Lore_Books_by_Author.md#Kandelwijj_the_Magnificent)** *A guide to becoming a successful stage performer*
---
