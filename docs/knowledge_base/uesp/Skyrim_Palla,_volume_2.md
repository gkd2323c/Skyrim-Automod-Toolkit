...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Basic Book1.png) Book Information <br> *Palla, volume 2* | | | |
| --- | --- | --- | --- |
| [ID](Skyrim_Form_ID.md) | 00 01ACF4 | | |
| See Also | [Lore version](Lore_Palla,_volume_2.md) | | |
| Up | *[Palla](Skyrim_Palla.md)* | | |
| Prev. | *[Volume 1](Skyrim_Palla,_volume_1.md)* | Next | None |
| [![Value](https://images.uesp.net/thumb/5/52/SR-item-Gold-heads.png/22px-SR-item-Gold-heads.png)](https://en.uesp.net/wiki/File:SR-item-Gold-heads.png) | 10 | [](https://en.uesp.net/wiki/File:SR-icon-clothing-Leather_Backpack_(square).png) | 1 |
| [Type](Skyrim_Books.md#Book_Types) | List 3 | | |
| Writer | [Ted Peterson](https://en.uesp.net/wiki/General:Ted_Peterson) | | |
| Locations | | | |
| Found in the following locations: - [Elgrim's Elixirs](Skyrim_Elgrim%27s_Elixirs.md), back room on a barrel <br> - [Volkihar Keep](Skyrim_Volkihar_Keep.md)<sup>[DG](Skyrim_Dawnguard.md)</sup>, on one of the shelves in the alchemy lab area | | | |

Palla, volume 2 **by [Vojne Mierstyyd](Lore_Books_by_Author.md#Vojne_Mierstyyd)** *A conjurer's tragic infatuation with a dead woman (volume 2 of 2)*
---
