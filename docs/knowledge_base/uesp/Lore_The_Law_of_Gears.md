...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:The_Law_of_Gears) ([Clockwork City](https://en.uesp.net/wiki/Online:Clockwork_City_(DLC))) |

The Law of Gears **by [Proctor Albacron](Lore_Books_by_Author.md#Proctor_Albacron), Second Innovator of the Sacred Flywheel** *A collection of lessons learned from Sotha Sil's Law of Gears*
---
In [Lord Seht](Lore_Sotha_Sil.md)'s name, these are the words of the Laws of Gears, annotated with one interpretation of the lesson each law teaches.
