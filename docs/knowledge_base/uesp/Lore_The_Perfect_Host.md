...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:The_Perfect_Host) |

The Perfect Host **by [Malenford Hlaalu](Lore_Books_by_Author.md#Malenford_Hlaalu), House Event Planner Extraordinaire** *On planning for a social event*
---
...
First, select a theme for your party or event. A good theme provides context for your gathering and gives your guests a fun and exciting motif to focus upon. Theme examples include classic [Dunmeri](Lore_Dunmer.md) plays, spring or fall harvest, [Nord](Lore_Nord.md) drinking games, and (my personal favorite) Grim Brooding Day.
