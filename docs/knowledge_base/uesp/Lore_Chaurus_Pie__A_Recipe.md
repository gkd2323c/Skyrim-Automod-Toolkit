...
| Book Information | |
| --- | --- |
| Seen In: | - [Skyrim](Skyrim_Chaurus_Pie__A_Recipe.md) |

Chaurus Pie: A Recipe **by [Nils](Lore_Books_by_Author.md#Nils)** *A recipe for a pie from chaurus meat* *
---
If I have to hear one more time about that famous gourmet who wrote that [recipe book](Lore_Uncommon_Taste.md), I'll hack off my own ears with a blunt axe.

Sure, he can cook up some dishes fit for them stodgy [Imperials](Lore_Imperial.md) and them poncy [Bretons](Lore_Breton.md), but real [Nords](Lore_Nord.md) want real Nord food, and my [chaurus](Lore_Chaurus.md) pie is just that.
