...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Thenephan%27s_Mysteries_of_Mead) |

Thenephan's Mysteries of Mead **by [Daria Thenephan](Lore_Books_by_Author.md#Daria_Thenephan)** *On the intricacies of creating and consuming Nord mead*
---
There's a reason I was kicked out of [Daggerfall](Lore_Daggerfall.md), chased out of [Elden Root](Lore_Elden_Root.md), and banned from [Mournhold](Lore_Mournhold.md). I've tried every variety of intoxicant, wine, ale, and [Argonian](Lore_Argonian.md) swill this world has to offer. I've sampled [skooma](Lore_Skooma.md) with [Khajiit](Lore_Khajiit.md), licked an Argonian [Hist](Lore_Hist.md) Tree, and hunted "[magical](Lore_Magic.md)" toads with the [Bosmer](Lore_Bosmer.md).

None of that compares to [Nord](Lore_Nord.md) [mead](Lore_Mead.md). There's nothing like it.

The purest stuff is made in Nord villages, but we're at war with the Nords, and a [Breton](Lore_Breton.md) has no guarantee of surviving a trip like that. Leave that sort of thing to the professionals. There is still hope, however. If you're ever at a tavern, and there's a cask of Nord mead, you'd be a fool to pass it up.

Mead is made by fermenting honey and water (though a few recipes call for molasses). Sometimes, you add grain mash and strain it, but that isn't necessary. Some of the [High Elves](Lore_Altmer.md) call it "honey wine," but mead needs more than good honey. Every meadery has its own recipes. After you drink enough mead, you learn the names of the brewmasters who create them. A drunk Nord will gladly punch another in the face over the honor of a good brewmaster. Then again, a drunk Nord will punch anyone for just about anything.
