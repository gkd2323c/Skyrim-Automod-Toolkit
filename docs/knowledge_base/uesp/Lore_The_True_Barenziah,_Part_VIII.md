...
| Seen In: | - [Daggerfall](https://en.uesp.net/wiki/Daggerfall:The_True_Barenziah,_Part_VIII) | | |
| Up | *[The Real Barenziah](Lore_The_Real_Barenziah_(Daggerfall).md)* | | |
| Prev. | *[Part 7](Lore_The_Real_Barenziah,_Part_VII.md)* | Next | *[Part 9](Lore_The_Real_Barenziah,_Part_IX.md)* |

[The True Barenziah](Lore_The_Real_Barenziah_(Daggerfall).md) Part VIII **by [Anonymous](Lore_Books_by_Author.md#Plitinius_Mero)** *Part 8 of an unauthorized biography of the famous Dark Elf Queen of Wayrest*
---
*Note: This is part of the original, uncensored series of books that appeared in * [Daggerfall](https://en.uesp.net/wiki/Daggerfall:Daggerfall) *. In subsequent games, this content appears in * [The Real Barenziah, v 4](Lore_The_Real_Barenziah,_v_4.md) * with some minor modifications.*
