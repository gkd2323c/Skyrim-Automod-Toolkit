...
| Seen In: | - [Morrowind](https://en.uesp.net/wiki/Morrowind:The_Seed) <br> - [Oblivion](https://en.uesp.net/wiki/Oblivion:The_Seed) <br> - [Skyrim](https://en.uesp.net/wiki/Skyrim:The_Seed) <br> - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Ancient_Scrolls_of_the_Dwemer_II) | | |
| Up | *[Ancient Tales of the Dwemer](Lore_Ancient_Tales_of_the_Dwemer.md)* | | |
| Prev. | *[Part I](Lore_The_Ransom_of_Zarek.md)* | Next | *[Part III](Lore_The_Importance_of_Where.md)* |

[Ancient Tales of the Dwemer](Lore_Ancient_Tales_of_the_Dwemer.md), Part II: The Seed **by [Marobar Sul](Lore_Books_by_Author.md#Marobar_Sul)** *Book 2 of an incomplete series of fictional stories about the Dwemer*
---
