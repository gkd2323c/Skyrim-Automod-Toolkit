...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Basic Book5.png) Book Information <br> *Charwich-Koniinge, v2* | | | |
| --- | --- | --- | --- |
| [ID](Skyrim_Form_ID.md) | 00 01B239 | | |
| See Also | [Lore version](https://en.uesp.net/wiki/Lore:Charwich-Koniinge,_Volume_2) | | |
| Up | *[Charwich-Koniinge Letters](https://en.uesp.net/wiki/Skyrim:Charwich-Koniinge_Letters)* | | |
| Prev. | *[Book I](Skyrim_Charwich-Koniinge_Letters,_v1.md)* | Next | *[Book III](Skyrim_Charwich-Koniinge_Letters,_v3.md)* |
...
| Locations | | | |
| Found in the following locations: - [Apocrypha (Waking Dreams)](Skyrim_Apocrypha_(Waking_Dreams).md)<sup>[DB](Skyrim_Dragonborn.md)</sup>, Chapter IV <br> - [Driftshade Refuge](Skyrim_Driftshade_Refuge.md), in a small crate on a balcony with clutter-filled shelves | | | |

The [Charwich-Koniinge Letters](https://en.uesp.net/wiki/Skyrim:Charwich-Koniinge_Letters)
Book II **by Koniinge** *Letter sent from Koniinge to Charwich about their search for Azura's Star*
---
...
I returned to the Pot and Plaster, reasoning that the priest must frequent that area of the city to feel so comfortable setting clandestine meetings there. It took some time searching, but I finally found him, and as luck would have it, he was alone. I called his name, and he quickly drew me to a dark alleyway, nervous that we would be seen by a Temple [ordinator](https://en.uesp.net/wiki/Skyrim:Ordinator).
