...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Journal3.png) Book Information <br> *Azarain's Journal* | | | |
| --- | --- | --- | --- |
| Added by | [Vigil Enforcer Armor Set](Skyrim_Vigil_Enforcer_Armor_Set.md) | | |
| [ID](Skyrim_Form_ID.md) | FE [xxx](Skyrim_Form_ID.md#Creation_Club) 927 | | |
...
| Needed for | [Unholy Vigil](Skyrim_Unholy_Vigil.md) | | |
| Locations | | | |
| Found in the following locations: - On [Azarain](Skyrim_Azarain.md)'s body at the [Windward Ruins](https://en.uesp.net/wiki/Skyrim:Windward_Ruins) | | | |

Azarain's Journal **by [Azarain](Skyrim_Azarain.md)** *The diary of a deceased Vigilant of Stendarr*
---
