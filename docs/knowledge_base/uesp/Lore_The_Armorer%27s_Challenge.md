...
| Seen In: | - [Morrowind](https://en.uesp.net/wiki/Morrowind:The_Armorer%27s_Challenge) <br> - [Oblivion](https://en.uesp.net/wiki/Oblivion:The_Armorer%27s_Challenge) <br> - [Skyrim](https://en.uesp.net/wiki/Skyrim:The_Armorer%27s_Challenge) |

The Armorer's Challenge **by [Mymophonus](Lore_Books_by_Author.md#Mymophonus)** *A competition between two skilled armorsmiths*
---
*This book had a companion image on the official Elder Scrolls website, [archived here](https://en.uesp.net/wiki/File:LO-book-The_Armorer%27s_Challenge.jpg).*

---
Three hundred years ago, when [Katariah](Lore_Katariah.md) became Empress, the first and only [Dunmer](Lore_Dunmer.md) to rule all of [Tamriel](Lore_Tamriel.md), she faced opposition from the [Imperial Council](https://en.uesp.net/wiki/Lore:Imperial_Council). Even after she convinced them that she would be the best regent to rule the [Empire](Lore_Third_Empire.md) while her husband [Pelagius](Lore_Pelagius_Septim_III.md) sought treatment for his madness, there was still conflict. In particular from the Duke of [Vengheto](https://en.uesp.net/wiki/Lore:Vengheto), Thane Minglumire, who took a particular delight in exposing all of the Empress's lack of practical knowledge.
...
"I know a very clever armorer," said Katariah, "His name is [Hazadir](https://en.uesp.net/wiki/Lore:Hazadir), an [Argonian](Lore_Argonian.md) who knows the environments our army will be facing. I knew him in [Vivec](Lore_Vivec_(city).md) where he was a slave to the master armorer there, before he moved to the [Imperial City](Lore_Imperial_City.md) as a freedman. We should have him design armor and weaponry for the campaign."

Minglumire gave a short, barking laugh: "She wants a slave to design the armor and weaponry for our troops! [Sirollus Saccus](https://en.uesp.net/wiki/Lore:Sirollus_Saccus) is the finest armorer in the Imperial City. Everyone knows that."

After much debate, it was finally decided to have both armorers contend for the commission. The Council also elected two champions of equal power and prowess, [Nandor Beraid](https://en.uesp.net/wiki/Lore:Nandor_Beraid) and Raphalas Eul, to battle using the arms and armaments of the real competitors in the struggle. Whichever champion won, the armorer who supplied him would earn the Imperial commission. It was decided that Beraid would be outfitted by Hazadir, and Eul by Saccus.
...
Out of kindness, and more than a bit of pride, Saccus showed Hazadir how, by contrast, things should be done in a real professional armory. The Argonian acted as an apprentice to Saccus, helping him refine the ebony ore, and to pound it and fold it when it cooled. Over the next several days, they worked together to create a beautiful dai-katana with an edge honed sharp enough to trim a mosquito's eyebrows, enchanted with flames along its length by one of the [Imperial Battlemages](https://en.uesp.net/wiki/Lore:Imperial_Battlemages), as well as a suit of armor of bound wood, leather, silver, and ebony to resist the winds of [Oblivion](Lore_Oblivion.md).
