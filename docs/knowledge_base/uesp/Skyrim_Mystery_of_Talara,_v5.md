...
| [](https://en.uesp.net/wiki/File:SR-icon-book-Basic Book6a.png) Book Information <br> *Mystery of Talara, v5* | | | |
| --- | --- | --- | --- |
| [ID](Skyrim_Form_ID.md) | 00 01ACF5 | | |
| See Also | [Lore version](Lore_Mystery_of_Talara,_v_5.md) | | |
| Up | *[Mystery of Talara](Skyrim_Mystery_of_Talara.md)* | | |
| Prev. | *[Part IV](Skyrim_Mystery_of_Talara,_Part_4.md)* | Next | None |
...
| Locations | | | |
| Found in the following locations: - [Bards College](Skyrim_Bards_College.md), in a crate on top of a small cupboard in the hallway just outside of an upstairs lecture hall <br> - [Temple of Dibella](Skyrim_Temple_of_Dibella.md), Inner Sanctum, on one of the bookshelves in the center area | | | |

The Mystery of Princess Talara Part V **by [Mera Llykith](Lore_Books_by_Author.md#Mera_Llykith)** *Part five of the story of Princess Talara*
---
"
