...
| Seen In: | - [Daggerfall](https://en.uesp.net/wiki/Daggerfall:The_Real_Barenziah,_Part_III) | | |
| Up | *[The Real Barenziah](Lore_The_Real_Barenziah_(Daggerfall).md)* | | |
| Prev. | *[Part 2](Lore_The_Real_Barenziah,_Part_II.md)* | Next | *[Part 4](Lore_The_Real_Barenziah,_Part_IV.md)* |

[The Real Barenziah](Lore_The_Real_Barenziah_(Daggerfall).md) Part III **by [Anonymous](Lore_Books_by_Author.md#Plitinius_Mero)** *Part 3 of an unauthorized biography of the famous Dark Elf Queen of Wayrest*
---
*Note: This is part of the original, uncensored series of books that appeared in * [Daggerfall](https://en.uesp.net/wiki/Daggerfall:Daggerfall) *. In subsequent games, this content appears in * [The Real Barenziah, v 2](Lore_The_Real_Barenziah,_v_2.md) * with some minor modifications and a significant censorship by replacing explicit text with "[This passage has been censored by order of the Temple]".*
