...
| Seen In: | - [Daggerfall](https://en.uesp.net/wiki/Daggerfall:The_Real_Barenziah,_Part_V) | | |
| Up | *[The Real Barenziah](Lore_The_Real_Barenziah_(Daggerfall).md)* | | |
| Prev. | *[Part 4](Lore_The_Real_Barenziah,_Part_IV.md)* | Next | *[Part 6](Lore_The_Real_Barenziah,_Part_VI.md)* |

[The Real Barenziah](Lore_The_Real_Barenziah_(Daggerfall).md) Part V **by [Anonymous](Lore_Books_by_Author.md#Plitinius_Mero)** *Part 5 of an unauthorized biography of the famous Dark Elf Queen of Wayrest*
---
*Note: This is part of the original, uncensored series of books that appeared in * [Daggerfall](https://en.uesp.net/wiki/Daggerfall:Daggerfall) *. In subsequent games, this content appears in * [The Real Barenziah, v 3](Lore_The_Real_Barenziah,_v_3.md) * with some minor modifications.*
