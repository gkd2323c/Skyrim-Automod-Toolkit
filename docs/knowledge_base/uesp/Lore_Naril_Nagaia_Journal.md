...
| Book Information | |
| --- | --- |
| Seen In: | - [Elder Scrolls Online](https://en.uesp.net/wiki/Online:Naril_Nagaia_Journal) |
...
The [Ayleid](Lore_Ayleid.md) script is highly advanced. The forms are morphologically mature compared to earlier inscriptions I'd found, suggesting that this place is one of the more recent ruins, from close to the height of the Ayleid power.
